...
//        @Bean
//        public SecurityFilterChain authorizationServerSecurityFilterChain1(HttpSecurity http) throws Exception {
//            OAuth2AuthorizationServerConfigurer authorizationServerConfigurer = new OAuth2AuthorizationServerConfigurer();
//
//            authorizationServerConfigurer.authorizationEndpoint(authorizationEndpoint ->
//                    authorizationEndpoint
//                            .consentPage("/oauth2/authorize") // Custom consent page
//            );
//
//            return http.build();
//        }
            ...
            return (context) -> {
                if (OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType())) {
                    context.getClaims().claims((claims) -> {
                        ...
                        claims.put("email", ((CustomUserDetails)context.getPrincipal().getPrincipal()).getUsername());
                    });
                }
            };
        }
